...
set(mavlink_DIALECTS ASLUAV;all;ardupilotmega;autoquad;common;development;icarous;matrixpilot;paparazzi;standard;uAvionix;ualberta)
set(mavlink2_DIALECTS ASLUAV;all;ardupilotmega;autoquad;common;development;icarous;matrixpilot;paparazzi;standard;uAvionix;ualberta)

foreach(lib )
  set(onelib "${lib}-NOTFOUND")
  find_library(onelib ${lib}
      PATHS "/home/traveller/Integration/devel/lib"
    NO_DEFAULT_PATH
    )
  if(NOT onelib)
